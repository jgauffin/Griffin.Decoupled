...
{
    /// <summary>
    /// I store root aggregate
    /// </summary>
    /// <typeparam name="TRootAggregate">Your entity/model type (for instance <c>User</c>)</typeparam>
    ...
    /// </remarks>
    public interface IDataStore<TRootAggregate, in TKey> where TRootAggregate : class
    {
        /// <summary>
        ...
        TRootAggregate Load(TKey key);

        /// <summary>
        /// Create or update.
        /// </summary>
        /// <param name="entity">Entity being saved.</param>
        void Save(TRootAggregate entity);
        ...
        void Delete(TRootAggregate entity);
    }
}